    ...
    <div>
      {status == null ? (
        <div className="flex space-x-8">
          ...
          <button className="px-4 py-2 bg-gray-500 text-white" onClick={() => markEmployee("sick", employeeId)}>Sick</button>
          <button className="px-4 py-2 bg-yellow-500 text-black" onClick={() => markEmployee("leave", employeeId)}>Leave</button>
        </div>
      ) : (
